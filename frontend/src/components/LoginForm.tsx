...
const LoginForm: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-md p-8">
      <div className="bg-gray-800/70 backdrop-blur-md p-8 rounded-xl border border-gray-700">
        ...
        <Button 
          ...
          disabled={isLoading}
          className="w-full bg-gray-700 hover:bg-gray-600 text-white flex items-center justify-center gap-3 py-3"
        >
